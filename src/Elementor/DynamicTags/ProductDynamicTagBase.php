<?php
/**
 * Base class for product dynamic tags.
 *
 * @package Catalogist
 */
...
/**
 * Abstract base class for product data dynamic tags.
 *
 * Provides common functionality for product-related dynamic tags.
 */
abstract class ProductDynamicTagBase {
	 ...
	 * @var array<string>
	 */
	protected array $tag_group = array( 'catalogist-products' );
	...
	/**
	 * Resolve catalog item from product ID.
	 *
	 * @param int $product_id Product ID.
	 *
	 * @return CatalogItem|null
	 */
	protected function resolve_catalog_item( int $product_id ): ?CatalogItem {
		// Use global function to get catalog item by product ID.
		return catalogist_get_catalog_item( $product_id );
	}
