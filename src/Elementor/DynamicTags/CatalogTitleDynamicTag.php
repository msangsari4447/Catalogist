 ...
 * Catalog title dynamic tag.
 *
 * Resolves the catalog title from the parent widget's catalog_id context.
 */
class CatalogTitleDynamicTag extends ProductDynamicTagBase {
	...
	public function get_name(): string {
		return 'catalogist_catalog_title';
	}
	...
	public function get_title(): string {
		return __( 'Catalog Title', 'catalogist' );
	}
	 ...
	 * loads the catalog via CatalogRepository, and returns the title.
	 *
	 * @return string
	 */
